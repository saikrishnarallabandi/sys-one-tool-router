...
CKPT = "exp/checkpoints/qwen3-0.6b-tool-router-100/best"
EXP_DIR = "exp/scale100"
MAX_LEN = 128
...
def main():
    ...
    with open("data/scale100/label_map.json") as f:
    ...
    vtexts, vlabels = load("data/scale100/data_val.jsonl")
    ...
    with open(f"{EXP_DIR}/temperature.json", "w") as f:
    ...
    ttexts, tlabels = load("data/scale100/data_test.jsonl")
    ...
    with open(f"{EXP_DIR}/eval_report.json", "w") as f:
